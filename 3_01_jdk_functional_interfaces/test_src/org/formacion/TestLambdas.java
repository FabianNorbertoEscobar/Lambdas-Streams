...
public class TestLambdas {
	...
	public void test_extras() {
		...
		Predicate<Persona> segundoApellidoEsNulo = p -> p.getApellido2() == null;
		
		assertTrue(segundoApellidoEsNulo.test(personaSinSegundoApellido));
		assertFalse(segundoApellidoEsNulo.test(personaConSegundoApellido));
